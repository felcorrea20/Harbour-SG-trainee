...
do while .t.
    ...
    if LastKey() == 27 
        @ 03,01 say "Escolha:   [C]ancelar [R]etornar"
        @ 03,09 get cEscolha picture "@!" valid cEscolha $ "CR"
        read
    ...
    do while nIteracoes < nEmpregados
        ...
        if LastKey() == 27
            @ 13,01 say "Escolha:   [C]ancelar [R]etornar [P]rocessar"
            @ 13,09 get cEscolha picture "@!" valid cEscolha $ "CRP"
            read
    ...
    cEscolha := Space(1) // para deixar vazia
    @ 22,01 say "Escolha:   [C]ancelar [R]etornar"
    @ 22,09 get cEscolha picture "@!" valid cEscolha $ "CR"
    read
